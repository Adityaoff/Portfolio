...
import { FiGithub, FiTwitter, FiLinkedin, FiInstagram, FiX, FiMenu, }
  from "react-icons/fi";
      ...
      >
        ...
        <div className="md:flex hidden items-center space-x-4">
          <motion.a
            ...
            transition={{ dalay: 1.3, duration: 0.8 }}
            className="text-gray-700 dark:text-gray-300
            hover:text-violet-600 dark:hover:text-violet-400
            transition-colors duration-300"
            href="https://github.com/Adityaoff"
          >
          ...
          <motion.a
            ...
            hover:text-violet-600 dark:hover:text-violet-400
            transition-colors duration-300"
            href="https://www.instagram.com/adityadj23545/"
          >
        ...
        <motion.button
          ...
          className=" md:flex hidden ml-4 px-4 py-2 rounded-xl bg-gradient-to-r
      ...
      >
        ...
        >
          <div className="flex space-x-5">
            <a href="https://github.com/Adityaoff">
            ...
            <a href="https://www.instagram.com/adityadj23545/">
        ...
        z-50 flex items-center justify-center p-4"
          ...
          shadow-xl w-full max-w-md p-6"
            ...
            mb-4 "
              ...
              from-violet-600 to bg-violet-400 hover:from-violet-700
